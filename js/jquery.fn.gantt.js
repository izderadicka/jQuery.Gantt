    ...
    $.fn.gantt = function (options) {
		...
		ganttLeftPanel
                    ...
                    case "hours":
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            if (rgetDay !== getDay) {
                                ...
                                dowArr.push('<div class="row day hours_scale' + day_class2 + '" '
                                        + ' style="width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                                        + ' <div class="fn-label">'+day.getDate() +' ' + settings.dow[getDay] + '</div></div>');
                        ...
                        dowArr.push('<div class="row day ' + day_class + '" '
                                + ' style="width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                                + ' <div class="fn-label">' + day.getDate() + ' ' + settings.dow[day.getDay()] + '</div></div>');
            ...
            navigation: function (element) {
                ...
                if (settings.navigate === "scroll") {
                  ...
                  if (element.pageCount>1) {
                   						ganttNavigate.append($('<div class="nav-slider-left" />')
                            ...
                            ganttNavigate.append($('<div class="nav-slider-bar" />')
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                } else if (settings.navigate==='buttons_limited'){
                    ganttNavigate = $('<div class="navigate" />');
                        if (element.pageCount>1) {
                   						ganttNavigate.append($('<div class="nav-slider-left" />')
                    ...
                    ganttNavigate.append($('<span role="button" class="nav-link nav-begin"/>')
                            .html('&#124;&lt;')
                            .click(function () {
            ...
            markNow: function (element) {
                switch (settings.scale) {
                    ...
                    default:
                        var cd = Date.parse(new Date());
                        cd = (Math.floor((cd+36400000) / 36400000) * 36400000);
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                default:
                                    ...
                                    if (dl*tools.getCellSize()+cFrom>core.maxOffset) {
                                    	dl=Math.floor((core.maxOffset-cFrom)/tools.getCellSize())
                                    }
                                    _bar = core.createProgressBar(
                                                dl,
                                                day.customClass ? day.customClass : "",
            ...
            navigateTo: function (element, val) {
                ...
                switch (val) {
                    ...
                    case "now":
                        ...
                        break;
                    default:
                        var max_left = rightPanelWidth-dataPanelWidth;
                        var cur_marg = $dataPanel.css("margin-left").replace("px", "");
        ...
        var tools = {
            ...
            getMaxDate: function (element) {
                ...
                switch (settings.scale) {
                    case "hours":
                        ...
                        maxDate.setHours(maxDate.getHours());
                        break;
                    case "weeks":
                        var bd = new Date(maxDate.getTime());
                        var bd = new Date(bd.setDate(bd.getDate()));
            ...
            dateDeserialize: function (dateStr) {
                ...
                var date = new Date(parseInt(dateStr.substring(6)));
                return date
